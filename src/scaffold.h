...
namespace scaffold {
  ...
  public:
    ...
    std::string init(int indent) {
      return indentation(indent) + name_ + " = new " + std::string("TTreeReaderValue<") + type_ + std::string(" >(reader, \"") + name_ + std::string("\");\n");
    }
    std::string loopHeader(int indent) {
      return std::string("");
    }
    std::string loop(int indent) {
      return indentation(indent) + std::string("std::cout << \"") + name_ + std::string(" \" << *(") + name_ + std::string("->Get()) << std::endl;\n");
    }
  };
  ...
  public:
    ...
    std::string init(int indent) {
      return indentation(indent) + name_ + " = new " + std::string("TTreeReaderArray<Char_t >(reader, \"") + name_ + std::string("\");\n");
    }
    std::string loopHeader(int indent) {
      return std::string("");
    }
    std::string loop(int indent) {
      return indentation(indent) + std::string("std::cout << \"") + name_ + std::string(" \" << (char*)") + name_ + std::string("->GetAddress() << std::endl;\n");
    }
  };
  ...
  public:
    ...
    std::string init(int indent) {
      return indentation(indent) + name_ + " = new " + std::string("TTreeReaderArray<") + type_ + std::string(" >(reader, \"") + name_ + std::string("\");\n");
    }
    std::string loopHeader(int indent) {
      return std::string("");
    }
